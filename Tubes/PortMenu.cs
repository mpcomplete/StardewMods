...
namespace Tubes
{
    ...
    internal class PortMenu : IClickableMenu
    {
        ...
        public PortMenu()
        {
            ...
            Rectangle Stardrop = new Rectangle(0, 410, 16, 16);
            this.AddButton = new ClickableTextureComponent(Stardrop, Sprites.Icons.Sheet, Stardrop, 2);
        ...
        public override void draw(SpriteBatch spriteBatch)
        {
             TubesMod._monitor.InterceptErrors("drawing the lookup info", () => {
                 ...
                 IClickableMenu.drawTextureBox(Game1.spriteBatch, Game1.menuTexture, menuTextureSourceRect, x, y, width, height, Color.White);
                 //scale: this.width / (float)Sprites.Letter.Sprite.Width);

                 foreach (var filter in this.Filters)
                     filter.Dropdown.draw(Game1.spriteBatch);
                 this.AddButton.draw(Game1.spriteBatch);
    ...
    internal static class Sprites
    {
        ...
        *********/
        ...
        public static class Icons
        {
            ...
            public static readonly Rectangle Stardrop = new Rectangle(0, 400, 800, 800);
        }
